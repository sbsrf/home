...
4. 掌握所选输入方案的具体内容。声笔的每一个输入方案都单独用了一章来讲解。声笔现在有七个主要输入方案，它们是：普及型的[声笔简码](../sbjm/) 、[声笔拼音](../sbpy/) ，中庸型的声笔双拼（包括[声笔自然](../sbzr/)和[声笔小鹤](../sbxh/)），以及专业型的声笔飞系（包括[声笔飞单](../sbfd/)、[声笔飞码](../sbfm/)和[声笔飞讯](../sbfx/)。另外，还有几个由它们衍生出来的整句方案：在声笔简码中还介绍了[声笔简整](../sbjm/#_7-声笔简整)，在声笔自然中还介绍了[声笔自整](../sbzr/#_5-声笔自整)，在声笔小鹤中还介绍了[声笔鹤整](../sbxh/#_5-声笔鹤整)，另有一篇文章介绍了[声笔三拼](../posts/sbsp.html)。
...
![image-20230708172332621](/images/image-20230708172332621.png)
...
就专业的输入方案来说，声笔飞码是比五笔字型等传统四码方案更好的选择。声笔飞码不分平翘舌的声母，加音托为主的偏旁部首，再加五种笔画，使得其的学习难度相对较低。顶功等编码技术的巧妙应用，使得声笔飞码的效率大大提高。在以单字输入为主的场合，声笔飞单适合单字派用户，只有少量可选的简词，而声笔飞讯则是独树一帜主单输入方案，在保持单字高效性的同时还支持大量词组的输入。
...
如果您现在使用的是笔画输入法，或者虽然您使用的是拼音但是对笔画的掌握不错，则建议您升迁到[声笔简码](../sbjm/)，它可以大大提升您的输入效率，只需要您知道拼音里的声母即可，而且不用区分平翘舌，门坎非常低，效率却比声笔拼音还高。

如果您喜欢双拼，但是对传统双拼的输入效率不满意，您就可以采用声笔双拼（包括[声笔自然](../sbzr/)和[声笔小鹤](../sbxh/)）。这样，可以用最小的代价，换来最大的效率提升。当然，如果您使用的不是自然码双拼和小鹤双拼，那么就建议您直接升迁到更高效声笔飞系，以避免不同的双拼方案所带来的习惯干扰。
...
如果您想更深入地了解声笔系列码，就请加入声笔系列码QQ群（780510469, 783734487, 445906697和728093309）以便与其他声笔系列码爱好者深度地交流使用心得，探讨顶功输入法技巧，提出改进意见，并获得宝贵的一手软件和资料。
