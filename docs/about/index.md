...
4. 掌握所选输入方案的具体内容。声笔的每一个输入方案都单独用了一章来讲解。声笔现在有三类主要输入方案，它们是：普及型的[声笔简码](../sbjm/) 、[声笔拼音](../sbpy/) ，中庸型的声笔双拼（包括[声笔自然](../sbzr/)和[声笔小鹤](../sbxh/)），以及专业型的声笔飞系（包括[声笔飞单](../sbfd/)、[声笔飞码](../sbfm/)和[声笔飞讯](../sbfx/)）。另外，还有几个由它们衍生出来的整句方案：衍生自声笔简码的[声笔简整](../sbjz/)，衍生自声笔自然的[声笔自整](../sbzz/)，衍生自声笔小鹤的[声笔鹤整](../sbxz/)，还有衍生自声笔拼音的[声笔三拼](../sbsp/)。
