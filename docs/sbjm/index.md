...
对于熟练的用户而言，可能会觉得高频的单字和二字词调频得过于频繁，导致人机交互过多。为了缓解这个问题，声笔简码提供了增强模式。在增强模式下，声笔简码提供了大量的固定数选字词，并且可以兼容飞系的单字，能够大大提高可盲打性。
...
![image-20240409110109470](/images/image-20240409110109470.png)

![image-20240409110134165](/images/image-20240409110134165.png)

![image-20240409091507447](/images/image-20240409091507447.png)
...
飞单的一简字和声笔字与简码完全相同，它的二、三简字则作为首选的注释用单引号或者Tab键选择，其它的单字通过将第四码aeuio置换为23789或者在第四码后追加单引号来输入，但是实际输入的编码始终是四码加单引号，以下是示例。
...
快单模式是在四顶模式基础上，用飞单的三简字代替简码的三简词而成。这样，飞单三简字就能够三码顶，只需要三键就可以输入，但是二字词则变为四码起顶了。如果配合增强模式使用，可以尽量使用数选词，使得单字和二字词的盲打率都可以大大地提高。

![image-20240411081315422](/images/image-20240411081315422.png)
