...
声笔简码的字词输入可以通过标选单字、数选字词和定制词典来增强。

### 4.1 标选单字

标选单字就是用标点来选择的单字，其编码格式为声母加标点，或者声母加笔画加标点。用于选择的标点有分号和单引号。但是，在提示级别为隐藏时，不会有提示。若把提示级别为有理、无理或者两者，那么会出现以下候选提示。

例如，输入w后，提示如下。

![image-20240513133101470](/images/image-20240513133101470.png)

再如，输入wi后，提示如下。

![image-20240513133939311](/images/image-20240513133939311.png)
...
![image-20240513134151326](/images/image-20240513134151326.png)

![image-20240513134213902](/images/image-20240513134213902.png)

![image-20240513134234021](/images/image-20240513134234021.png)
...
例如，输入vi后的结果如下。其中，「昂唉哎喔」都是用无理数字来选择的。

![image-20240513134346142](/images/image-20240513134346142.png)
