...
![image-20240418073628424](/images/image-20240418073628424.png)
...
![image-20240416213234413](/images/image-20240416213234413.png)

![image-20240416213259067](/images/image-20240416213259067.png)
...
![image-20240417191914170](/images/image-20240417191914170.png)

再如，输入ze后的情况如下，选择方法与上例相同。

![image-20240417191942395](/images/image-20240417191942395.png)

又如，在输入zy后，如果直接输入`’456`或者Tab将顺序选择「怎样 重要 只要 主要 终于」五个词。

![image-20240417191731438](/images/image-20240417191731438.png)

## 4 自定词典

声笔简整的所有固定字词，包括一简字、声笔字、声声词等，以及所有固定的数选字词，都是可以修改定制的，它们位于sbjz.fixed.txt文件中。您修改保存后，重新部署一下就可以生效。