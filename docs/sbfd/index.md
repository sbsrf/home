...
通过a引导的拼音还支持用字海两分法来进行反查， 支持查找八万多汉字，一般用于反查难读而易于两分的字或者输入GBK以外的字。GBK以外的字，飞单不提供正常编码，不能按正常方式输入，只能在两分查找到后，移动光标选中并用空格上屏。
...
![image-20240304123402798](/images/image-20240304123402798.png)
