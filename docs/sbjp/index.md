...
2. 二字词：`s(b*8)sbb`，即各字的声母加末字的前两笔，再加首字的前五笔，最长编码空间为`21^2*5^10 = 4,306,640,625`；
3. 三字词：`s(bb)s(bb)sbb`，即各字的声母加末字的前两笔，加首字的前两笔，再加第二字的前两笔，最长编码空间为`21^3*5^6 = 144,703,125`；
4. 四字词：`s(bb)s(bb)s(bb)sbb`，即各字的声母加末字的前两笔，加首字的前两笔，加次字的前两笔，再加第三字的前五笔，最长编码空间为`21^4*5^8 = 75,969,140,625`；
