...
如要启用声笔自整、声笔鹤整、声笔三拼方案，请在 `default.custom.yaml` 中自行添加。有图形界面的，如小狼毫和同文，也可以通过图形界面添加。

声笔拼音有专章论述，声笔简整在声笔简码中讲解，声笔自整在声笔自然中讲解，声笔鹤整在声笔小鹤中讲解，声笔三拼请参见[声笔三拼](../posts/sbsp.html)。
