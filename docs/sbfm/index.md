...
飞码的单字除了三简字可以被顶上屏幕外，其二简字也可以在一定条件下被组合起来上屏。二字组合是指在输入二字词的时候，若想要的第一字为二简字而第二字为三简字或全码字时，可以追加第二字的第三码，与第一字进行组合。

这时，会有两种情况。，一是追加的第三码与选择键没有冲突。

例如，在输入「飞系」的时候，发现系统没有该词，而且「系」字的第三码u又没有被重码词占用，那么在输入u的时候就会将「飞」字与「系」字组合，形成「飞系」。如下图所示，注意「飞系」后面的五角星表示该「词」为组合形成的。这样，就不必用退格键来清除xx两码，用空格先上屏「飞」字，再输入「系」字了。

![image-20250818054730080](/images/image-20250818054730080.png)

![image-20250818054748974](/images/image-20250818054748974.png)

另一种情况是，追加的第三码与选择键有冲突。

例如，在输入「二纪」的时候，发现系统没有该词，但是「纪」的第三码a已经被重码「二舅」占用，所以在输入a后首选项为「二舅」。但是，当你再用分号键时，就可将其转换为「二」「纪」两字，没有丝毫浪费。

![image-20250818060718491](/images/image-20250818060718491.png)

![image-20250818060850406](/images/image-20250818060850406.png)

这时，前两码对应的不一定是你想要的二简字，但是转换后肯定是二简字。所以，要想在有冲突时使用二字组合，你得对二简字要烂熟于心！二字组合的好处是，能够避免不必要的回改，从而节约按键，让输入变得更加流畅。
