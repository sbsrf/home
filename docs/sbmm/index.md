...
![键盘助记](/images/DEC6DFCCA145F5155C21B8ACF07938AC.png)
...
猛码单字的全码重码，在极速字频前3500字内只有29个重码，它们都有无理二简编码。也就是说，只要记住了字根编码，学会了单字拆分，掌握了这29个无理字（如下所列），就可以99.98%的概率来盲打单字。因此，猛盲单字盲打的门槛很低。
...
- 三码词：3380个，取全码的前两码加末字末根首笔，例如「会不会 so,」「糕点 so.」等。

![image-20251123114249950](/images/image-20251123114249950.png)

- 四码词：8万4千多个，取全码的前三码加末字末根首笔，例如「滑梯 fjz/」「导航栏 fjz,」「清产核资 fjz;」等。
