...
![image-20240329152428773](/images/image-20240329152428773.png)

再如，输入ze后的情况如下，选择方法与上例相同。

![image-20240329152519544](/images/image-20240329152519544.png)

又如，在输入zy后，如果直接输入`’456`将顺序选择「怎样 重要 只要 主要」四个词。

![image-20240329152554366](/images/image-20240329152554366.png)
