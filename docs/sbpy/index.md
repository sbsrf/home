...
![image-20240504110716958](/images/image-20240504110716958.png)

对于零声母字，如「案」字，在反查时除了用`a` 引导还需要在正常拼音的前面加 `v`，因为 an 是零声母音，所以实际的输入为 `avan`。在下图中提示出的`案vaaoo`，表示「案」字的编码为 `vaaoo`。

![image-20240504110743343](/images/image-20240504110743343.png)
...
![image-20240504110811294](/images/image-20240504110811294.png)
...
![image-20240504110842182](/images/image-20240504110842182.png)

![image-20240504110858447](/images/image-20240504110858447.png)

对于非 GBK 字集里的「㕛」字，它是没有编码的，只能用两分法来输入，如下所示。

![image-20240504110928199](/images/image-20240504110928199.png)
...
![image-20240518075031216](/images/image-20240518075031216.png)
