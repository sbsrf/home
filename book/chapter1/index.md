...
输入法最重要的特征在于编码和解码，这可以追溯到林语堂先生在1947年发明的明快打字机。林语堂是文学大师、语言学家，曾两度获得诺奖提名。他的打字机采用上下形检字法，取左上和右下部件编码，然后进行选择，实现了三键一字。在机械打字时代，他首次把键盘检索汉字的思路落地，成为后世输入法的源头，但是由于成本太高，商业化失败，未能普及。

1976年，朱邦复先生发明了仓颉输入法，原名形意检字法^23^。他提出了汉字基因理论，系统解决汉字输入、内码、字形和排序等问题。在1982年，他公开放弃专利，以推动中文电脑普及。仓颉输入法为纯形码，最多五码，适合输入繁体汉字，目前在几乎所有繁体操作系统中都有内置，在繁体中文用户中影响很大。
...
1986年，王永民先生发明的五笔字型（又称王码）推出86版，1998年推出98版，2008年推出新世纪版^22^。他从1978年起，用五年时间，把12000多个汉字逐一拆解，最终归纳为130种基本字根，分布在25个字母键上，最多四码。五笔字型是典型的纯形码方案，重码率低，熟练后可做到快速盲打，曾是专业录入人员的不二之选。它被预装在四通打字机和微软Windows、IBM OS/2等主流操作系统中，曾经遍布全国大街小巷的五笔打字培训班也助推了它的传播，覆盖了数千万用户，是简体中文形码输入法中最具影响力的一款。
...
在输入法技术发展的同时，信息论作为一门基础理论学科也在同步发展，为输入法的科学化研究提供了坚实的理论基础。

1948年，克劳德·香农（Claude E. Shannon）在《贝尔系统技术杂志》上发表了划时代的论文《A Mathematical Theory of Communication》（通信的数学理论），标志着信息论作为一门独立学科的诞生。在这篇论文中，香农提出了信息熵的概念，建立了通信系统的数学模型，并证明了三个基本定理——无噪信道编码定理、有噪信道编码定理和率失真定理，为整个信息时代奠定了理论基础。

几乎与香农发表信息论论文同时，林语堂先生在1947年发明了明快打字机，首次将键盘检索汉字的思路落地。这两件发生在同一时期的大事，一个奠定了信息科学的理论基础，一个开启了汉字编码输入的实践探索，虽然当时并无交集，但在数十年后，信息论的思想逐渐渗透到输入法研究领域，为中文输入法的设计和评估提供了科学的理论框架。

1994年，陈一凡和胡宣华合著的《汉字键盘输入技术与理论基础》出版，这是国内第一本系统论述汉字输入技术的学术专著。该书首次从信息论的角度分析了汉字输入问题，讨论了汉字特征信息、编码理论、系统评估等问题，标志着输入法研究开始从经验试错走向科学化、理论化。

2005年，戴石麟在其硕士论文《汉字编码输入法研究》中，进一步将信息论的方法系统应用于汉字编码研究，提出了基于信息论的输入系统模型，深入分析了顶功编码的原理和优势，为顶功输入方案提供了理论支撑。

近年来，随着大模型和人工智能的发展，信息论与语言学、认知科学的结合更加紧密。语言模型的困惑度（perplexity）、互信息、交叉熵等信息论概念，已经成为评估输入法智能程度的重要指标。信息论不仅是通信工程的基础，也正在成为输入法理论研究的核心工具。
